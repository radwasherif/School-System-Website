...
-- INSERT INTO Assignments(assignment_number, course_code, school_id, post_date, due_date, contenet, teacher_id)
...
-- INSERT INTO Announcements(title, announcement_date, type, descriptoin, admin_id, school_id)
-- VALUES('Concert', '2016-10-1', 'activities', 'The school band will play a concert next week.', 11, 2); 

-- INSERT INTO Announcements(title, announcement_date, type, descriptoin, admin_id, school_id)
-- VALUES('Trip', '2016-10-23', 'trip', 'Trip to the nationl museum of Arts next week.', 11, 2);
