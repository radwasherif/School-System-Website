...
CREATE PROCEDURE admin_assign_courses_to_student(IN admin_id INT)
BEGIN 
...
-- not required procedure, but needed
CREATE PROCEDURE teacher_apply_to_school(IN teacher_id INT, IN school_id INT)
BEGIN
	UPDATE Employees E 
	SET E.school_id = school_id 
	WHERE E.id = teacher_id;
END //
