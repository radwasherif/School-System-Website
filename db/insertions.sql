...
INSERT INTO Courses (code, name, description, grade, level)
VALUES (402, 'Introduction to English Literature', 'Studying an easy novel to get a feeling for English literature.', 4,
        'middle');
INSERT INTO Courses (code, name, description, grade, level)
VALUES (1002, 'Advanced English Literature',
        'Going into depth into English Literature. Studying Hamlet by William Shakespeare', 10, 'high');
INSERT INTO Courses (code, name, description, grade, level)
